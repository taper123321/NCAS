...
typedef int fpos_t;
  ...
  int open(const char * path,int sysmode,int perms);
  int close(int fileno);
  size_t read(int handle,void * buf,size_t size,int readpos);
  size_t write(int handle,const void * buf,size_t size);
  off_t lseek(int handle,int offset,int mode);
...
int printf(const char * fmt, ...);
  ...
  int vsnprintf(char *str, size_t s,const char *fmt, va_list ap) ; // no size check
